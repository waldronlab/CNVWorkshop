...
author:
  - name: Ludwig Geistlinger
    affiliation: School of Public Health, City University of New York, New York
  ...
  - name: Seyhun Oh
    affiliation: School of Public Health, City University of New York, New York
    email: Seyhun.Oh@sph.cuny.edu
  - name: Levi Waldron
    affiliation: School of Public Health, City University of New York, New York
    email: Levi.Waldron@sph.cuny.edu
abstract: >
    This workshop gives an overview of Bioconductor solutions for the 
    analysis of copy number variation (CNV) data. 
...
# Allele-specific CN analysis with PureCN

[PureCN](http://bioconductor.org/packages/PureCN)

Further information can be found in the 
[vignette](http://www.bioconductor.org/packages/release/bioc/vignettes/PureCN/inst/doc/PureCN.pdf)
and [publication](https://doi.org/10.1186/s13029-016-0060-z).
