...
knitr::include_graphics(system.file("vignettes/RaggedExperiment.png", package = "CNVWorkshop"))
```
...
```{r, echo=FALSE}
knitr::include_graphics(system.file("vignettes/CNVRanger.png", package = "CNVWorkshop"))
```
...
knitr::include_graphics(system.file("vignettes/overview_1.png", package = "CNVWorkshop"))
```
...
knitr::include_graphics(system.file("vignettes/overview_2.png", package = "CNVWorkshop"))
```
...
```{r echo=FALSE, out.width = '180%'}
knitr::include_graphics(system.file("vignettes/overview_3.png", package = "CNVWorkshop"))
```

### Analysis examples
```{r example_output, echo=FALSE, warning=FALSE, message=FALSE}
library(PureCN)
file.rds = system.file("extdata/Sample1_PureCN.rds", package = "CNVWorkshop")
...
knitr::include_graphics(system.file("vignettes/analysis_example.png", package = "CNVWorkshop"))
```
