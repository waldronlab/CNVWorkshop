...
knitr::include_graphics(system.file("vignettes/puri_ploi.png", package = "CNVWorkshop"))
```
...
knitr::include_graphics(system.file("vignettes/TMB.png", package = "CNVWorkshop"))
```
...
knitr::include_graphics(system.file("vignettes/MutSig.png", package = "CNVWorkshop"))
```
